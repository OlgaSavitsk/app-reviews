...
export const DeleteReview = createAction(`${actionSource} delete review`, props<{ id: string }>());
...
export const GetReviewsTags = createAction(`${actionSource} get tags`);

export const GetReviewsTagsSuccess = createAction(
  `${actionSource} get tags success`,
  props<{ tags: string[] }>()
);
